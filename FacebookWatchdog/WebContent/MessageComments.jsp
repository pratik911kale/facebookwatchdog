...
UserInfo rsUser = dao.getUserRecord(info);
	...
	// Get comments on Message uploaded by user
      ArrayList<MessageCommentBean> rsComments = daoComments.getComments(messId);
      
      MessageDAO daoMessage = new MessageDAO();
      MessageBean rsMessage = daoMessage.getMessageById(messId);
      
      String liked = daoMessage.postLiked(email, messId);
...
<div class="st-container">
          ...
          <form action="UsersRegistered" method="Get" class="navbar-form margin-none navbar-left hidden-xs ">
            ...
            <div class="search-1">
              <div class="input-group">
                ...
                <input type="hidden" name="viewid" value="MessageComments.jsp">
    ...
    <div class="chat-window-container"></div>
          ...
          <div class="container-fluid">
            ...
            <div class="media-body">
             ...
             <div class="tabbable">
                  ...
                  %>
                   <a href="Profile.jsp?email=<%= email %>"> <img src="<%= profImage %>" alt="image" width="50" height="50"/> </a> <font color="royalblue" size="3"> <a href="Profile.jsp?email=<%= email %>"><%= userFirstName + " "+ userLastName %> </a> uploaded a Post</font>
                  <%
                       }
           ...
           <a href="UserProfile.jsp?userEmail=<%= userEmail %>"> <img src="<%= profImage %>" alt="image" width="50" height="50"/> </a> <font color="royalblue" size="3"> <a href="UserProfile.jsp?userEmail=<%= userEmail %>"><%= userFirstName + " "+ userLastName %> </a> uploaded a Post</font>
           <%
                       }
           %>
            ...
            <br/>
             ...
             <% 
                              ...
                              &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;  &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
                                 <a href="javascript:unlikePostMess('<%= messId %>','<%= email %>','<%= userEmail %>')" id="liked">Unlike</a> &nbsp; &nbsp;
                               ...
                               <a href="javascript:likePostMess('<%= messId %>','<%= email %>','<%= userEmail %>')" id="liked">Like</a> &nbsp; &nbsp;
         ...
         <center>
            ...
            <form style="width: 700px;" action="InsertCommentMess" name="form1" method="post">
                 ...
                 <input type="hidden" id="messId" name="messId" value="<%= messId %>">
                 <input type="hidden" id="useremail" name="userEmail" value="<%= userEmail %>">
                 <input type="hidden" id="email" name="email" value="<%= email %>">
                  <input type="hidden" id="inputpage" name="inputPage" value="MessageComments.jsp">
            ...
            <center>
                 ...
                 <input type="hidden" id="messId1" name="messId" value="<%= messId %>">
                 <input type="hidden" id="useremail1" name="userEmail" value="<%= userEmail %>">
                 <input type="hidden" id="email1" name="email" value="<%= email %>">
                 <input type="hidden" id="inputpage1" name="inputPage" value="MessageComments.jsp">
            </form>
                          ...
                          <div class="pull-right dropdown" data-show-hover="li">
                            ...
                            <%
                                System.out.println("User Of comment equal to email: "+userOfComment.equals("email"));
                                  ...
                                  {
                             %>   	  
                             <li><a href="MessageComments.jsp?messId=<%= messId%>&email=<%= email%>&userEmail=<%= userEmail %>&inputPage=MessageComments.jsp&input=Edit&comment=<%= rsComments.get(commentsCount).getComment() %>&commentId=<%= rsComments.get(commentsCount).getId() %>">Edit</a></li>
                              <li><a href="DeleteMessComment?messId=<%= messId %>&email=<%= email%>&userEmail=<%= userEmail %>&inputPage=MessageComments.jsp&commentId=<%= rsComments.get(commentsCount).getId() %>">Delete</a></li>
                            </ul>
...
request.onreadystatechange=function getInfo(){  
	if(request.readyState==4){  
		var val="javascript:unlikePostMess('"+messId+"','"+email+"','"+userEmail+"')"; 
...
{  
  ...
  request.onreadystatechange=function success(){  
	if(request.readyState==4){  
		var val="javascript:likePostMess('"+messId+"','"+email+"','"+userEmail+"')";
...
{  
	...
	var messId = document.getElementById('messId1').value;
